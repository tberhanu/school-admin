...
2. TEMPORARILY: Setting Environmental Variable TEMPORARILY
    --> schoolAdmin$ export DJANGO_SETTINGS_MODULE=schoolAdmin.settings.dev
3. TEMPORARILY: After changing the SETTINGS file location, Django may get confused and raise errors like
